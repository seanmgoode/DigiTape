...
- **RX**: live DigiTape receiver screen for `DigiTape-TX` over BLE.
- **Settings**: sends offset and response mode back to TX using the RX 2.0.2 settings characteristic.
...
4. Build and run.
5. Start in Emulator mode first, then turn Emulator Mode off and tap **Connect to DigiTape-TX**.
