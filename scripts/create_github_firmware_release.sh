...
TAG="${TAG:-v2.0.7}"
TITLE="${TITLE:-DigiTape Firmware v2.0.7}"
ROOT="${ROOT:-/Users/seangoode/Desktop/DigiTape}"
APP_DIR="${APP_DIR:-$ROOT/App/data/DigiTape_iOS_Controller_2.0.2}"

RX_BIN="$ROOT/Digitape Current INOs/DigiTape_RX_2_0_2/release/ota-update/INSTALL_DigiTape_RX_2_0_7.ino.bin"
TX_BIN="$ROOT/Digitape Current INOs/DigiTape_TX_2_0_4/release/ota-update/INSTALL_DigiTape_TX_2_0_6.ino.bin"
MANIFEST="$APP_DIR/docs/firmware-manifest.github-v2.0.7.json"
...
upload_asset "$RX_BIN" "INSTALL_DigiTape_RX_2_0_7.ino.bin" "application/octet-stream"
upload_asset "$TX_BIN" "INSTALL_DigiTape_TX_2_0_6.ino.bin" "application/octet-stream"
