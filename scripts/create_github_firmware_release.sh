...
TAG="${TAG:-v2.0.8}"
TITLE="${TITLE:-DigiTape Firmware v2.0.8}"
...
TX_BIN="$ROOT/Digitape Current INOs/DigiTape_TX_2_0_4/release/ota-update/INSTALL_DigiTape_TX_2_0_7.ino.bin"
MANIFEST="$APP_DIR/docs/firmware-manifest.github-v2.0.8.json"
